...
Route::middleware('user')->group(function() {
    ...
    Route::post('/courses/{id}', [CourseController::class, 'update']); // UPDATE COURSE BY ID
    ...
    Route::post('/courses/{course_id}/contents/{id}', [ContentController::class, 'update']); // UPDATE CONTENT
    ...
    Route::post('/courses/{course_id}/assignments/{id}', [AssignmentController::class, 'update']);
